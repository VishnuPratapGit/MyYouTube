...
const EditPostForm = ({ toggleCreate }) => {
    ...
    return (
        <div id="outerbox" className="flex absolute top-0 h-full w-full justify-center items-center border-dashed">
            <div id="innerbox" className="flex flex-col h-full w-full shadow-2xl bg-white dark:bg-neutral-800 rounded-3xl">
                ...
                <div className="flex items-center flex-1 overflow-y-scroll">
                    <div className="flex w-full p-5 px-12 h-full gap-10 font-roboto">
                        ...
                        <div id="video-info" className="flex-1">
                            <div className="bg-neutral-900 rounded-lg w-full max-w-80 h-3/4 relative">
                                {videoLoader && <div className="absolute z-10 w-full h-40"><PreLoader className="relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" color="gray" /></div>}
